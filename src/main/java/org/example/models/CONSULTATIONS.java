...
public class CONSULTATIONS {
    ...
    public CONSULTATIONS(int consultation_id, int doctor_id, int patient_id, String status, String diagnosis, int rate, LocalDateTime request_time, LocalDateTime consultation_time) {
